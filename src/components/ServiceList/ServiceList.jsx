...
const service = [
    ...
    {id:'1', title:'Развитие отдела продаж', price: 800, description: 'Наши мощные облачные сервисы помогут вам оптимизировать все внутренние рабочие процессы в одном месте, чтобы стимулировать продажи'},
    {id:'1', title:'Веб-разработка', price: 1000, description: 'Наши разработчики создают первоклассные веб-решения, которые являются многофункциональными, быстрыми и масштабируемыми'},
