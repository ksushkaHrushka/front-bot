...
const service = [
    ...
    {id:'1', title:'Развитие отдела продаж', price: 800, decription: 'Наши мощные облачные сервисы помогут вам оптимизировать все внутренние рабочие процессы в одном месте, чтобы стимулировать продажи'},
